...
# 5. ARAMA ARAYÜZÜ (BOŞLUK AZALTILDI VE GAP EKLENDİ)
...
# Arama butonu
search_button = st.button("Dükkanları ve Fiyat Sorulacak Yerleri Bul", use_container_width=True, type="primary")
                ...
                for idx, dukkan in enumerate(sonuclar):
                    ...
                    with st.container(border=True):
                        ...
                        with b1:
                            ...
                            st.link_button("📍 Konum / Yol Tarifi", harita_link, use_container_width=True, key=f"map_btn_{idx}_{pid}")
                        ...
                        with b2:
                            if tel:
                                ...
                                st.link_button("💬 WhatsApp'tan Fiyat Sor", wa_link, type="primary", use_container_width=True, key=f"wa_btn_{idx}_{pid}")
                            else:
                                st.button("💬 No Mevcut Değil", disabled=True, use_container_width=True, key=f"none_btn_{idx}_{pid}")
            else:
